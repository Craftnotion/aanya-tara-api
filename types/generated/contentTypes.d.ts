...
export interface ApiAboutpageAboutpage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    commitment_badge: Schema.Attribute.String;
    commitment_left_desc: Schema.Attribute.Text;
    commitment_left_image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    commitment_right_desc: Schema.Attribute.Text;
    commitment_right_image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    commitment_services_list: Schema.Attribute.Component<
    ...
    > &
      Schema.Attribute.Private;
    location_badge: Schema.Attribute.String;
    location_bg: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    location_desc: Schema.Attribute.Text;
    location_title: Schema.Attribute.String;
    locations_list: Schema.Attribute.Component<
      'homepage-components.location-feature',
      true
    >;
    philosophy_badge: Schema.Attribute.String;
...
export interface ApiCallrequestCallrequest extends Struct.CollectionTypeSchema {
  collectionName: 'callrequests';
  info: {
    displayName: 'Call_request';
    pluralName: 'callrequests';
    singularName: 'callrequest';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiCtaFooterCtaFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    cta_bg_image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    cta_desc: Schema.Attribute.Text;
    cta_desc2: Schema.Attribute.Text;
    cta_title: Schema.Attribute.String;
    cta_title2: Schema.Attribute.String;
    ...
    social_google_url: Schema.Attribute.String;
    social_instagram_url: Schema.Attribute.String;
    social_twitter_url: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiGallerypageGallerypage extends Struct.SingleTypeSchema {
  collectionName: 'gallerypages';
  info: {
    displayName: 'Gallery_page';
    pluralName: 'gallerypages';
    singularName: 'gallerypage';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    tab_1_images: Schema.Attribute.Media<
      ...
      true
    >;
    tab_1_label: Schema.Attribute.String;
    tab_2_images: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    tab_2_label: Schema.Attribute.String;
    tab_3_images: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    tab_3_label: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    Amenities_section: Schema.Attribute.Component<
      'homepage-components.amenity-section',
      false
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    Gallery_section: Schema.Attribute.Component<
      'homepage-components.gallery-section',
      false
    >;
    hero_desc: Schema.Attribute.Text;
    hero_title: Schema.Attribute.String;
    ...
    Introduction_section: Schema.Attribute.Component<
      'homepage-components.intro-section',
      false
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
    ...
    Location_section: Schema.Attribute.Component<
      'homepage-components.location-section',
      false
    >;
    Promise_section: Schema.Attribute.Component<
      'homepage-components.promise-section',
      false
    >;
    publishedAt: Schema.Attribute.DateTime;
    SEO_details: Schema.Attribute.Component<'page-optimisation.seo', false>;
    ...
    Testimonial_section: Schema.Attribute.Component<
      'homepage-components.testimonial-section',
      false
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiRoomRoom extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    bathroom_count: Schema.Attribute.String;
    booking_url: Schema.Attribute.String;
    card_desc: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    gallery: Schema.Attribute.Media<
      ...
      true
    >;
    guests_count: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiRoomspageRoomspage extends Struct.SingleTypeSchema {
  collectionName: 'roomspages';
  info: {
    displayName: 'Rooms_page';
    pluralName: 'roomspages';
    singularName: 'roomspage';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    Experience_section: Schema.Attribute.Component<
      'room-detailspage.experience-item',
      true
    >;
    hero_badge: Schema.Attribute.String;
    hero_bg: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    ...
    stay_checkout_label: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::callrequest.callrequest': ApiCallrequestCallrequest;
      'api::contactpage.contactpage': ApiContactpageContactpage;
      'api::cta-footer.cta-footer': ApiCtaFooterCtaFooter;
      'api::enquiry.enquiry': ApiEnquiryEnquiry;
      'api::gallerypage.gallerypage': ApiGallerypageGallerypage;
      'api::homepage.homepage': ApiHomepageHomepage;
      'api::room.room': ApiRoomRoom;
      'api::roomspage.roomspage': ApiRoomspageRoomspage;
